...
router.post("/bulk", (req, res) => {
  ...
  const tickets = db.createBulkTicket(userName, price, quantity);
  res
    .status(201)
...
router.get("/draw", (req, res) => {
  ...
  const winners = db.raffleDraw(winnerCount);
  const ticket = db.createBulkTicket(winnerCount);
